...
import Attendance from './AttendanceHod';
import EmployeeLeave from './LeaveHod';
import Announcements from './Announcements/AnnouncementsHod';
import EmployeeProfile from './ProfileHod';
import EmployeeOrganization from './OrganisationHod';
import Employee from './EmployeesHod';
...
const MainBody = ({ employeeData, activeSection, setActiveSection }) => {
  ...
  const employeeSidebarLinks = [
    ...
    },
    {
      ...
      icon: <Users className='iconsP' size={20} />,
      color: '#27ae60',
      component: <Employee employeeId={employeeData?.id} />
    },
    {
      id: 'chat',
      label: 'Announcements',
